      ...
      <section>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fill, minmax(300px, 1fr))', gap: 20 }}>
          {normalizedOps.map((op) => (
            <div key={op.id} style={{ 
              ...operationCard, 
              borderTop: op.risk === "ATTENTION" ? '4px solid #e53e3e' : '4px solid #38a169' 
            }}>
              ...
              <div style={{ marginTop: 15, paddingTop: 15, borderTop: '1px solid #edf2f7', display: 'flex', justifyContent: 'space-between' }}>
                 <span style={{ fontSize: '12px', color: op.risk === "ATTENTION" ? '#e53e3e' : '#718096', fontWeight: 'bold' }}>
                   {op.risk === "ATTENTION" ? "⚠️ LOCATION NEEDED" : "✓ STATUS OK"}
                 </span>
