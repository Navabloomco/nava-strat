    ...
    <main className="min-h-screen bg-slate-950 px-4 py-6 text-white sm:px-8 sm:py-10">
      <div className="mx-auto max-w-4xl">
        <PageHeader
          ...
          title="Legacy tracking processor retired"
          body="Raw provider processing has moved into secured provider sync and asset review workflows."
        />
        ...
        <Panel dark className="mt-8 p-6">
          <div className="grid gap-3 sm:grid-cols-3">
            <RetiredLink href="/admin/providers" label="Provider Vault" />
            <RetiredLink href="/admin/assets" label="Asset Review" />
            <RetiredLink href="/tracking/live" label="Live Tracking" />
          </div>
        </Panel>
      </div>
    </main>
...
function RetiredLink({ href, label }: { href: string; label: string }) {
  return (
    <Link
      href={href}
