...
Nava Eye location answers should be operational, not coordinate-first. Prefer provider place labels, geofence/place context, nearby town/landmark wording, movement status, and freshness. Do not show raw latitude/longitude in normal answers unless the user explicitly asks for GPS/coordinates or no readable place label exists.
